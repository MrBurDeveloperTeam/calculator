...
> = ({ stats }) => {
  ...
  const bodyPath =
    'M 40 30 Q 70 70 100 65 Q 130 70 160 30 Q 190 80 180 150 Q 170 195 100 190 Q 30 195 20 150 Q 10 80 40 30 Z';
      ...
      {isOpen && (
        ...
        >
          <div className="text-center">
            ...
            <div className="mt-2 h-3 w-full overflow-hidden rounded-full bg-slate-200 shadow-inner">
              <div
                className="
                  h-full
                  bg-amber-400
