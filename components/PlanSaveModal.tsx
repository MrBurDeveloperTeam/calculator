      ...
      <div className="relative bg-white rounded-lg shadow-2xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-200 ring-1 ring-slate-900/5">
        ...
        <div className="px-6 py-4 bg-gray-50 border-t border-gray-200 flex justify-end gap-3">
            ...
            <button 
                ...
                disabled={!name.trim()}
                className="px-6 py-2 text-sm bg-teal-600 text-white font-bold rounded-sm hover:bg-teal-700 disabled:opacity-50 disabled:cursor-not-allowed shadow-md shadow-teal-900/10 flex items-center gap-2 transition-all active:scale-[0.98]"
            >
