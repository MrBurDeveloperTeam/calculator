  ...
  <div className="flex flex-col w-full group">
    <div className="flex justify-between items-center mb-1 px-1">
      <div className="flex items-center gap-1.5 font-medium text-black">
        <div className="text-black group-hover:scale-110 transition-transform duration-300 drop-shadow-sm">
            {icon}
        </div>
        <span className="text-[10px] font-bold uppercase tracking-wider text-black opacity-100">
            {label}
        </span>
      </div>
    </div>
  ...
  return (
    <div
      className="
        absolute
        left-1/2
        top-[calc(env(safe-area-inset-top)_+_6rem)]
        z-30
