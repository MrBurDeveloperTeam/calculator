 ...
 * 3. Read Snabbb's Zustand localStorage key safely as read-only fallback.
 * 4. Store this calculator mini-app's fallback in localStorage['theme'] only.
