...
//
// export function useProfitCalculatorPersonalizedInsight(): ProfitCalculatorInsightCandidate | null {
...
import { createUseProfitCalculatorPersonalizedInsight } from '@mrburdeveloperteam/pet-function/apps/calculator';
import { useCalculator } from '../../context/CalculatorContext';
export const useProfitCalculatorPersonalizedInsight = createUseProfitCalculatorPersonalizedInsight(useCalculator);
