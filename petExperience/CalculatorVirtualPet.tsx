...
interface CalculatorVirtualPetProps {
  isOpen: boolean;
  onClose: () => void;
  /** Profit Calculator's own authenticated user id — see this file's
   *  header for why no additional auth lookup happens here. */
  userId: string | null;
...
export default function CalculatorVirtualPet({ isOpen, onClose, userId, extraGames }: CalculatorVirtualPetProps) {
