    ...
    >
      ...
      >
        {(
          ...
          return (
            ...
            >
              ...
              <span
                className={`text-[13px] tracking-wider font-bold uppercase transition-colors ${
                  !disabled
                    ? 'text-pink-500'
                    : 'text-slate-400'
                }`}
        ...
        >
          ...
          <span
            className={`text-[13px] pt-1 tracking-wider font-bold uppercase transition-colors ${
              isSoapedUp
                ? 'text-cyan-600'
                : 'text-slate-400'
            }`}
